<?php
    ...
    class YodleeAggregation 
    {
        ...
        private function api_call($action, $sendParameters)
        {
            $url = '';
            switch($action)
            {
                case 'getAllSiteAccounts'   : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_GET_ALL_SITE_ACCOUNTS; break;
                
                case 'getPopularSites'      : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_GET_POPULAR_SITES; break;
                
                case 'searchSites'          : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_SEARCH_SITES; break;
                
                case 'addSiteAccount'       : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_ADD_SITE_ACCOUNT; break;
                
                case 'getItemSummariesForSite' : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_GET_ITEM_SUMMARIES_FOR_SITE; break;
                
                case 'searchTransactions'      : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_SEARCH_TRANSACTIONS; break;
                
                case 'getUserTransactions'     : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_GET_USER_TRANSACTIONS; break;
                
                case 'categorizeTransactions'  : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_CATEGORIZE_TRANSACTIONS; break;
                
                case 'removeSiteAccount'       : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_REMOVE_SITE_ACCOUNT; break;
                
                case 'removeItemAccount'       : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_REMOVE_ITEM_ACCOUNT; break;
                
                case 'startSiteRefresh'        : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_START_SITE_REFRESH; break;
                
                case 'getTransactionCategoryTypes'  : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_TRANSACTION_CATEGORY_TYPE; break;
                
                case 'getUserTransactionCategories' : $url = Yodlee\ConfigInc\serviceBaseUrl.Yodlee\ConfigInc\URL_GET_USER_TRANSACTION_CATEGORY; break;
            }
            ...
            return Yodlee\restClient::Post($this->config["url"], $this->config["parameters"]);
        }
...
//            print_r($response);
        ...
        public function getAllSiteAccounts()
        {
                ...
                $this->response_to_request = $this->api_call('getAllSiteAccounts', $sendParameters);
        ...
        public function getPopularSites()
        {
                ...
                $this->response_to_request = $this->api_call('getPopularSites', $sendParameters);
        ...
        public function searchSites()
        {
                ...
                $this->response_to_request = $this->api_call('searchSites', $sendParameters);
        ...
        public function addSiteAccount($site, $login, $passwd)
        {
            ...
            $login_form = array(
                ...
                $this->response_to_request = $this->api_call('addSiteAccount', $sendParameters);
        ...
        public function getItemSummariesForSite($SiteAccId)
        {
                ...
                $this->response_to_request = $this->api_call('getItemSummariesForSite', $sendParameters);
        ...
        public function searchTransactions($itemAccountId)
        {
                ...
                $this->response_to_request = $this->api_call('searchTransactions', $sendParameters);
        ...
        public function getUserTransactions()
        {
                ...
                $this->response_to_request = $this->api_call('getUserTransactions', $sendParameters);
        ...
        /**
         * Categorize Transactions ( manual categorization and re-categorization by the consumer ).
         * 
         * @return void
         */
        ...
        public function removeSiteAccount()
        {
            ...
            $this->response_to_request = $this->api_call('removeSiteAccount', $sendParameters);
        ...
        public function startSiteRefresh()
        {
            ...
            $this->response_to_request = $this->api_call('startSiteRefresh', $sendParameters);
