$(function(){
    //$("#btn-session-Token").trigger('click');
});
...
$(function(){
	...
	var editUserSessionToken = $.getNewTextArea("response-userSessionToken");
	 ...
	 editSearchSite = $.getNewTextArea("response-searchSite");
	...
	$("#btn-session-Token").click(function(){
		...
		$.ajax({
			...
			url:    "src/cobrandSessionToken.php",
